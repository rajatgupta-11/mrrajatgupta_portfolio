...
const projects: Project[] = [
  {
    ...
    status: "COMPLETED",
    description: "Designed and built a 6-legged 18-DOF platform under $150. ESP32-based WiFi control and synchronized multi-joint actuation.",
  ...
  },
  {
    ...
    title: "Autonomous Quadcopter Control Platform",
    status: "ACTIVE_DEV",
    description: "Betaflight tuning and PPO reinforcement learning in Isaac Sim with traditional PID architectures.",
    type: "projects" as const,
  ...
  },
  {
    ...
    description: "MuJoCo simulation for kinetic launch systems. Reduced post-release oscillatory hinge loads by 90%.",
    type: "projects" as const,
    href: "projects/kinetic.html",
    previews: [
      "projects/assets/images/accelerator.png",
      "projects/assets/images/bode-plot.png",
  ...
  },
  {
    ...
    previews: [
      "projects/assets/images/ui.png",
      "projects/assets/images/button.png",
